...
pubDatetime: 2025-04-14T11:45:00Z
title: 🦀 Rust Basic
slug: rust-basic
featured: true
draft: false
...
### Tuple
  ...
  คือชนิดของข้อมูลที่สามารถเก็บค่าชนิดแบบต่างกันได้ซึ่งจะแตกต่างกับ `Vector` เพราะ `Vector` เก็บข้อมูลชนิดเดียวกันเท่ากัน โดยปกติจะใช้ในการ return value จาก function ออกมา
